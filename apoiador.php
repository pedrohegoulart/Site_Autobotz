...
<html lang="pt-br">
    <head>
        ...
        <title>Autobotz UFMG | Apoiador</title>
    ...
    <body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="100">
       ...
       <div id="preloader">
        ...
        <section class="ten_question_area">
        	<div class="container">
        		<div class="ten_title">
					<h2><span>Apoie</span> nossa Equipe</h2>
        			<p>A Autobotz está sempre ansiosa para fazer novas conexões com grandes empresas.</p>
        		</div>
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body">
									Como patrocinador da Autobotz, usaremos com orgulho o seu logotipo em nossos robôs e projetos.
									A equipe da Autobotz também é altamente qualificada para oferecer oficinas com seus produtos em grandes eventos como a 
									Maker Fair ou FINIT, ou dentro da Escola de Engenharia da UFMG.
								</div>
							</div>
						</div>
					</div>
		...
		<section class="contact_seven_area violet" id="contact">
				...
				<h3 style="color:#c9343c;">
					<?php 
						//Recuperando o valor da variável global, os erro de login.
							if(isset($_SESSION['MensagemApoioErro'])){
								echo $_SESSION['MensagemApoioErro'];
								unset($_SESSION['MensagemApoioErro']);
					}?>
				</h3>
			</div>
			<div class="contact_seven_box">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<form class="contact_us_form row" action="acess/apoio.php" method="post" id="contactForm" novalidate="novalidate">
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control" id="name" name="nome" placeholder="Nome">
                                </div>
                                <div class="form-group col-lg-6">
                                    <input type="number" class="form-control" id="phone" name="telefone" placeholder="Telefone">
                                </div>
                                <div class="form-group col-lg-6">
                                    <input type="email" class="form-control" id="email" name="email" placeholder="E-mail">
                                </div>
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control" id="subject" name="assunto" placeholder="Assunto">
                                </div>
			...
			<div class="contact_seven_map">
				...
				<script>
					var map;
					var iconBase = 'http://localhost/Autobotz/img/';
					function initMap() {
						...
						var marker = new google.maps.Marker({position: autobotz_loc, map: map, icon: iconBase + 'marcador-r2.png'});
