    ...
    <body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="100">
       ...
       <div id="preloader">
                ...
                <div class="screenshot_tab">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home" style="text-align: justify;">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eius- mod tempor incididunt ut labore et dolore magna aliqua Ut enim.</p>
        ...
        <section class="ten_question_area">
        	<div class="container">
        		<div class="ten_title">
					<h2><span>Entre</span> em nossa Equipe</h2>
					...
					<div class="row">
						<div class="col-md-8">
							<form class="contact_us_form row" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Curso">
                                </div>
                                <div class="form-group col-lg-6">
                                    <input type="email" class="form-control" id="email" name="email" placeholder="E-mail">
                                </div>
                                <div class="form-group col-lg-6">
                                    <input type="text" class="form-control" id="subject" name="subject" placeholder="Área">
                                </div>
