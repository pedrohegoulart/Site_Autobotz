...
<html lang="pt-br">
    <head>
        ...
        <title>Autobotz UFMG | Esteira</title>
    ...
    <body data-spy="scroll" data-target="#bs-example-navbar-collapse-1" data-offset="100">
       ...
       <div id="preloader">
        ...
        <section class="ten_question_area">
        	<div class="container">
        		<div class="ten_title">
					<h2>Veículo autônomo <span>Esteira</span></h2>
        			<p>Um veículo autônomo construído para IEEE Open para percorrer diferentes tipos de solo e atender a muitos vigias.</p>
        		</div>
						...
						<div class="panel panel-default">
							...
							<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								<div class="panel-body" style="text-align: justify;">
									...
									uma cadeira de praia e um guarda-sol - inseridos na arena como obstáculos.</div>
							</div>
						</div>
						<div class="panel panel-default">
        		...
        		<div class="flip_ten_slider">
					<ul class="flip-items">
						<li data-flip-title="Red">
							<img src="img/Projects/Esteira/img-esteira1.jpg" alt="">
						</li>
						<li data-flip-title="Red">
							<img src="img/Projects/Esteira/img-esteira2.jpg" alt="">
						</li>
						<li data-flip-title="Red">
							<img src="img/Projects/Esteira/img-esteira3.jpg" alt="">
						</li>
					</ul>
				</div>
        	</div>
